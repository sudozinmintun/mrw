...
class ProductsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				products.product_description LIKE ? OR 
				products.photo LIKE ? OR 
				products.images LIKE ? OR 
				products.created_at LIKE ? OR 
				products.updated_at LIKE ? OR 
				products.sub_title_1 LIKE ? OR 
				products.sub_description_1 LIKE ? OR 
				products.sub_title_2 LIKE ? OR 
				products.sub_description_2 LIKE ? OR 
				products.sub_title_3 LIKE ? OR 
				products.sub_description_3 LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("title","product_description","photo","images","sub_description_3");
			...
			$this->rules_array = array(
				...
				'photo' => 'required',
				'images' => 'required',
				'sub_description_3' => 'required',
			);
			$this->sanitize_array = array(
				'title' => 'sanitize_string',
				'product_description' => 'sanitize_string',
				'photo' => 'sanitize_string',
				'images' => 'sanitize_string',
				'sub_description_3' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","title","product_description","photo","images");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'title' => 'required',
