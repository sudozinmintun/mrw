                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-project_year"  value="<?php  echo $data['project_year']; ?>" type="text" placeholder="Enter Project Year"  required="" name="project_year"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-type_of_service"  value="<?php  echo $data['type_of_service']; ?>" type="text" placeholder="Enter Type Of Service"  required="" name="type_of_service"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
